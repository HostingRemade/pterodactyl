                            ...
                            <tr>
                                <td style="line-height: 24px; font-size: 16px; margin: 0;" align="left">
                                    ...
                                    <table class="ax-center" role="presentation" align="center" border="0" cellpadding="0" cellspacing="0" style="margin: 0 auto;">
                                        ...
                                        <tr>
                                            <td style="line-height: 24px; font-size: 16px; margin: 0;" align="left">
                                                <img class="w-24" src="https://i.imgur.com/OpIQgSi.png" style="height: auto; line-height: 100%; outline: none; text-decoration: none; display: block; border-style: none; border-width: 0;" width="319" height="89">
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
                                        ...
                                        <tr>
                                            <td style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 40px;" align="left" bgcolor="#ffffff">
                                                ...
                                                <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                                    ...
                                                    <tr>
                                                        <td style="line-height: 24px; font-size: 16px; margin: 0;" align="left">
                                                            <table class="btn" role="presentation" border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate !important;">
                                                                <tbody>
                                                                <tr>
                                                                    <td style="border-radius: 6px; background-color: #3490dc;" bgcolor="#3490dc">
                                                                        <p>If you believe this is a mistake, please contact us at <a href="mailto:support@hostingremade.net" class="hover-underline" style="text-decoration: underline;">support@hostingremade.net</a>.</p>
                                                                    </td>
                                                                </tr>
                                                                </tbody>
                                                            </table>
                                                ...
                                                <p class="" style="line-height: 24px; font-size: 16px; width: 100%; margin: 0;" align="left">
                                                    If you did not purchase this service, please contact us at <a href="mailto:support@hostingremade.net" class="hover-underline" style="text-decoration: underline;">support@hostingremade.net</a>.
                                                </p>
                                                <table class="s-4 w-full" role="presentation" border="0" cellpadding="0" cellspacing="0" style="width: 100%;" width="100%">
                                                    <tbody>
                                                    <tr>
                                    ...
                                    <table class="card p-6 p-lg-10 space-y-4" role="presentation" border="0" cellpadding="0" cellspacing="0" style="border-radius: 6px; border-collapse: separate !important; width: 100%; overflow: hidden; border: 1px solid #e2e8f0;" bgcolor="#ffffff">
                                        <tbody>
                                        <tr>
                                            <td style="line-height: 24px; font-size: 12px; width: 100%; margin: 0;" align="left" bgcolor="#ffffff">
                                                <p class="text-center" style="line-height: 24px; font-size: 12px; width: 100%; margin: 0;" align="center">
                                                    Sent from HostingRemade Limited - Please DO NOT reply to this email
                                                </p>
                                            </td>
                                        </tr>
                                        </tbody>
